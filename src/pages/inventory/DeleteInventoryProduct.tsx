...
import { deleteInventoryProduct } from "@/features/inventroyLogs/inventoryLogs";

export function DeleteInventoryProduct({ id }: { id: string }) {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      toast.success("Chek muvaffaqiyatli o'chirildi!");
      queryClient.invalidateQueries({ queryKey: ["inventoryLogs"] }); // Cache yangilash
    },
    onError: () => {
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Ushbu chekni o'chirmoqchimisiz?
            </DialogDescription>
          </DialogHeader>
        </DialogContent>
      </Dialog>
    ...
    <Drawer open={open} onOpenChange={setOpen}>
      ...
      <DrawerContent>
        <DrawerHeader className="text-left">
          ...
          <DrawerDescription>Ushbu chekni o'chirmoqchimisiz?</DrawerDescription>
        </DrawerHeader>
